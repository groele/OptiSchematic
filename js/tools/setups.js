      ...
      const notes = {
        ...
        michelson: `
          <div style="font-size:13px;color:var(--text-secondary);line-height:1.7">
            ...
            <ul style="padding-left:20px">
              ...
              <li>偏振退偏效应：如果分束镜 BS 对 s 偏振和 p 偏振的反射、透射率不相等（偏振分束），会降低最终干涉条纹的对比度（可见度 V）。</li>
            </ul>
          </div>`,
        moke: `
          <div style="font-size:13px;color:var(--text-secondary);line-height:1.7">
            ...
            <p style="margin-bottom:10px"><strong>设计要点：</strong></p>
            <ul style="padding-left:20px">
              <li style="color:var(--orange)">超低磁光双折射窗口：恒温器光窗在高低温和磁场条件下极易产生残余热应力双折射。需采用特制平面消应力石英窗口玻璃以防偏振面畸变。</li>
              <li>精密差分平衡：半波片和检偏分束镜 Wollaston 必须精密调谐至差分平衡点（A和B端电信号差值为零），以发挥平衡探测器抑制 RIN 共模噪声的最佳效果。</li>
            </ul>
          </div>`,
        fp: `
          <div style="font-size:13px;color:var(--text-secondary);line-height:1.7">
        ...
        ultrafast: `
          <div style="font-size:13px;color:var(--text-secondary);line-height:1.7">
            ...
            <p style="margin-bottom:10px"><strong>设计要点：</strong></p>
            <ul style="padding-left:20px">
              <li style="color:var(--green)">超连续白光色散补偿：白光在聚焦并穿过样品时会产生显著的群速度色散（Chirp，不同色光到达样品的时间不同）。需在数据后处理中利用溶剂双光子偏振关联曲线进行色散校正。</li>
